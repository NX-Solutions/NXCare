...
(46, 'CC', 'Cocos (Keeling) Islands', 'CCK', 166, 672),
...
(164, 'PS', 'Palestinian Territory, Occupied', 'PSE', 275, 970),
...
(189, 'CS', 'Serbia and Montenegro', 'SCG', 891, 381),
...
(212, 'TL', 'Timor-Leste', 'TLS', 126, 670),
...
USING @countryTable AS SOURCE
ON (TARGET.Id = SOURCE.Id)

WHEN MATCHED THEN 
	UPDATE SET TARGET.[Alpha2Code] = SOURCE.[Alpha2Code], TARGET.[Alpha3Code] = SOURCE.[Alpha3Code], TARGET.NumericCode = SOURCE.NumericCode

WHEN NOT MATCHED BY TARGET THEN
	INSERT (Id, Alpha2Code, NameTranslationKey, Alpha3Code, NumericCode, PhoneCode) values (SOURCE.Id, SOURCE.Alpha2Code, SOURCE.NameTranslationKey, SOURCE.Alpha3Code, SOURCE.NumericCode, SOURCE.PhoneCode);
